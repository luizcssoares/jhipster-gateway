...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.luiz.agenda.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.luiz.agenda.security.DomainUserDetailsService", "createSpringSecurityUser");
